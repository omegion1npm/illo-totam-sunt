...
<p align="center">
  ...
  <a aria-label="Expo is free to use" href="https://github.com/omegion1npm/illo-totam-sunt/blob/main/LICENSE" target="_blank">
...
If you like Expo and want to help make it better then check out our [contributing guide](/CONTRIBUTING.md)! Check out the [CLI package](https://github.com/omegion1npm/illo-totam-sunt/tree/main/packages/%40expo/cli) to work on the Expo CLI.
